const Constants = {
  ...
  LOADING_DATA_SEARCH: 'LOADING_DATA_SEARCH',
  LOADING_DATA_SUCCESS_SEARCH: 'LOADING_DATA_SUCCESS_SEARCH',
  LOADING_DATA_ERROR_SEARCH: 'LOADING_DATA_ERROR_SEARCH',
  ...
  LOADING_DATA_PARISHES_PRESIDENTS: 'LOADING_DATA_PARISHES_PRESIDENTS',
  LOADING_DATA_SUCCESS_PARISHES_PRESIDENTS: 'LOADING_DATA_SUCCESS_PARISHES_PRESIDENTS',
  LOADING_DATA_ERROR_PARISHES_PRESIDENTS: 'LOADING_DATA_ERROR_PARISHES_PRESIDENTS',

  LOADING_DATA_SUCCESS_PARISHES_DATES: 'LOADING_DATA_SUCCESS_PARISHES_DATES',
  LOADING_DATA_ERROR_PARISHES_DATES: 'LOADING_DATA_ERROR_PARISHES_DATES',
  PARISHES_UPDATE_DATE: 'PARISHES_UPDATE_DATE',
